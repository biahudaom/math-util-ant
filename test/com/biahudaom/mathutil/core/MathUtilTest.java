...
public class MathUtilTest {
     ...
     //Hàm getF() đc thiết kế trả về con long nếu n đưa vào 0..20
    //hàm getF() đc thiết kế NÉM RA EXCEPTION NẾU TA ĐƯA NÀO N < 0 || N > 20
    ...
    //ngoại lệ thuộc nhóm/class IllegalArgumentException xuất hiện hay ko
    //nó xh = cách nó được new IllegalArgumentException ở đâu đó
...
//TÊN LÀ TEST SCRIPT
//TEST SCRIPT LÀ NHỮNG ĐOẠN CODE ĐƯỢC VIẾT RA ĐỂ TEST CODE KHÁC, CODE CHÍNH
...
//@Test @ được gọi là ANNOTATION, kí hiệu, flag, để đánh dấu đoạn code
//mang ý nghĩa nào đó. Và khi biên dịch/compile code thì
//thư viện đi kèm nó sẽ tự động generate thêm code cho mình tùy theo @
//Ví dụ @Test thì thư viện JUnit nãy import nó sẽ ngấm ngầm tự generate
...
//JDBC ko phải framework, vì ko bị ép viết theo cú pháp, quy tắc của nó
...
//LIBL là những file .jar .dll chứa 1 đống class bên trong
...
//code gọn hơn, đẹp hơn, dễ bảo trì hơn, kiểm soát đc thủ thiếu các case
